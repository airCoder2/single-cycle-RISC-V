-- Date        : March 7, 2026
-- File        : stimulus_driver_Decoder_4_to_16.vhd    
-- Designer    : Salah Nasriddinov
-- Description : This file implements a stimulus driver for 4 to 16 Decoder testbench
...
entity stimulus_driver_Decoder_4_to_16 is
	generic(ITERATIONS : integer; WAIT_TIME : time);

	Port(RANDOM_DATA    : out std_logic_vector(3 downto 0);
		 DECODER_ENABLE : out std_logic);
end entity stimulus_driver_Decoder_4_to_16;

architecture behavioral of stimulus_driver_Decoder_4_to_16 is
begin 
    stimuli_process: process
        -- variables for the random number generator
        variable seed1, seed2 : positive := 1;
        variable rand_real    : real;
        variable rand_N1      : unsigned(3 downto 0);
    begin
