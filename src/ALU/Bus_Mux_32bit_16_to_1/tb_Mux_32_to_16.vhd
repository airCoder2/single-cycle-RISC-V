...
architecture behavior of tb_Mux_16_to_1 is
	...
	component stimulus_driver_Mux_16_to_1 is
		generic(
			   ITERATIONS   : integer;
	...
	end component stimulus_driver_Mux_16_to_1;

  -- Temporary signals to connect to the DUT.
	signal selec_mux  	   : std_logic_vector(3 downto 0);
	signal random_data : std_logic_vector(15 downto 0);
	signal mux_out : std_logic;

begin

	stimulus_d: stimulus_driver_Mux_16_to_1
